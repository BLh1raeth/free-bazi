...
const styles = StyleSheet.create({
  ...
  compactFortuneContent: { paddingTop: 1, paddingBottom: 2 },
  compactFortuneHeader: { height: 20, paddingHorizontal: 8, justifyContent: "center" },
  compactFortuneTitle: { color: palette.primary, fontSize: 12, fontWeight: "800" },
  compactFortuneScroll: { paddingHorizontal: 2 },
  ...
  compactFortuneSelected: {
    backgroundColor: "rgba(226, 233, 245, 0.86)",
    borderRadius: 8,
  ...
  compactFortuneGlyph: { fontSize: 17, lineHeight: 20, fontWeight: "800", includeFontPadding: false },
  compactFortuneGod: { maxWidth: 21, color: palette.text, fontSize: 6.5, fontWeight: "700" },
  compactFortuneFooter: { height: 10, lineHeight: 10, color: palette.muted, fontSize: 6.5, textAlign: "center" },
